...
- Sleep and mood check-in fields for a fuller daily picture
- One-tap 250 ml / 500 ml water logging
...
- Weekly text export
- Full JSON backup export and restore, including saved photos
- Configurable exercise target alongside calorie and water goals
